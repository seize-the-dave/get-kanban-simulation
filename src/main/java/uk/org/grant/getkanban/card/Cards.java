...
public class Cards {
    private final Map<String, Card> cards = new HashMap<>();
    {
        ...
        cards.put("E1", new ExpediteCard("E1", Card.Size.NONE, 4, 6, 4));
        cards.put("E2", new ExpediteCard("E2", Card.Size.NONE, 2, 3, 4, new FixedSubscriberProfile(-6)));
        ...
        cards.put("F1", new FixedDateCard("F1", Card.Size.NONE, 4, 3, 6));
        cards.put("F2", new FixedDateCard("F2", Card.Size.NONE, 5, 6, 4));
    }
